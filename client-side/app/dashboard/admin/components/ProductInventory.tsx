    ...
    <>
      <section>
        ...
        <div className="flex justify-between items-center mb-6">
          <h2 className="text-black text-2xl font-bold">Product Inventory</h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {filteredProducts.map((item) => (
            ...
            >
              <h6 className="text-black font-semibold">ID: {item.id}</h6>

              <h4 className="text-black font-semibold">{item.name}</h4>

              <p className="text-black">Price: ₹{item.price}</p>

              <p className="text-black">Code: {item.productCode}</p>
      ...
      <div>
        <button onClick={() => setPage(page + 1)} className="text-black">
          next
        </button>
        <button disabled={page===1} onClick={() => setPage(page - 1)} className="text-black">
          prev
        </button>
      </div>
    </>
